...
signalScriptCfg = {
  # Setup
  'inputWSDir': '/uscms/home/tsievert/nobackup/XHYbbgg/CombineFits/BoostedRootFiles/ws_singleH',
  'procs':'singleH', # if auto: inferred automatically from filenames
  'cats':'cat0', # if auto: inferred automatically from (0) workspace
  'ext':'2223_singleH',#_%s_nGaus'%_year,
