...
experimental_systematics = [
                ...
                {'name':'weight_PreselSF','title':'CMS_hgg_PreselWeight','type':'factory','prior':'lnN','correlateAcrossYears':1},
                ...
                {'name':'weight_bTagSF_sys_lf','title':'CMS_hgg_bTagLF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'weight_bTagSF_sys_hf','title':'CMS_hgg_bTagHF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'weight_bTagSF_sys_lfstats1','title':'CMS_hgg_bTagLFStats1','type':'factory','prior':'lnN','correlateAcrossYears':0},
                {'name':'weight_bTagSF_sys_lfstats2','title':'CMS_hgg_bTagLFStats2','type':'factory','prior':'lnN','correlateAcrossYears':0},
                {'name':'weight_bTagSF_sys_hfstats1','title':'CMS_hgg_bTagHFStats1','type':'factory','prior':'lnN','correlateAcrossYears':0},
                {'name':'weight_bTagSF_sys_hfstats2','title':'CMS_hgg_bTagHFStats2','type':'factory','prior':'lnN','correlateAcrossYears':0},
