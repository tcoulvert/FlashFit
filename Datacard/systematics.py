...
experimental_systematics = [
                # RooDataHist systematics (coming from separate Root files)
                {'name':'JEC','title':'CMS_hgg_JEC','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'JER','title':'CMS_hgg_JER','type':'factory','prior':'lnN','correlateAcrossYears':1},
                # RooDataSet systematics (coming from weight systematics in the nominal Root file)
                {'name':'PreselSF','title':'CMS_hgg_PreselWeight','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'Pileup','title':'CMS_hgg_PileupWeight','type':'factory','prior':'lnN','correlateAcrossYears':1},
                ...
                # bTag systematics split by sources
                {'name':'bTagSF_sys_lf','title':'CMS_hgg_bTagLF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'bTagSF_sys_hf','title':'CMS_hgg_bTagHF','type':'factory','prior':'lnN','correlateAcrossYears':1},
                {'name':'bTagSF_sys_lfstats1','title':'CMS_hgg_bTagLFStats1','type':'factory','prior':'lnN','correlateAcrossYears':0},
                {'name':'bTagSF_sys_lfstats2','title':'CMS_hgg_bTagLFStats2','type':'factory','prior':'lnN','correlateAcrossYears':0},
                {'name':'bTagSF_sys_hfstats1','title':'CMS_hgg_bTagHFStats1','type':'factory','prior':'lnN','correlateAcrossYears':0},
                {'name':'bTagSF_sys_hfstats2','title':'CMS_hgg_bTagHFStats2','type':'factory','prior':'lnN','correlateAcrossYears':0},
                # Applied by hand systematics (SHOULD BE AVOIDED IF POSSIBLE!!)
                {'name':'lumi_13p6TeV_2022','title':'lumi_13p6TeV_2022','type':'constant','prior':'lnN','correlateAcrossYears':0,'value':"1.014"},
                {'name':'lumi_13p6TeV_2023','title':'lumi_13p6TeV_2023','type':'constant','prior':'lnN','correlateAcrossYears':0,'value':"1.013"},
              ]
